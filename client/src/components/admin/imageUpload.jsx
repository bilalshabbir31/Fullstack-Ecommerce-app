...
const ProductImageUpload = ({ imageFile, imageLoadingState, setImageFile, uploadedImageUrl, setUploadedImageUrl, setImageLoadingState, isEditMode, isCustomStyling = false }) => {
